    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
            <div class="form-group">
                ...
                {!! Form::select('country', [" "] + \App\Models\Dictionary::where('tipus', '=', '16')->pluck('nev', 'id')->toArray(), null,['class'=>'select2 form-control', 'id' => 'country']) !!}

            </div>
            <div class="form-group">
                <label for="title">Selectcountry State:</label>
